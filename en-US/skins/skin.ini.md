...
|    JudgementCounterPosX     |        Integer         | MidRight  |       0        | The X position of the judgement counter relative to its default position                                        |
|    JudgementCounterPosY     |        Integer         | MidRight  |       0        | The Y position of the judgement counter relative to its default position                                        |
